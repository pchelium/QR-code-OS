 ...
 * Size: 40 px
 * Bpp: 4
 * Opts: --user-data-dir=C:\Users\admin\AppData\Roaming\gui-guider --app-path=C:\nxp\GUI-Guider-1.7.2-GA\resources\app.asar --no-sandbox --no-zygote --lang=cs --device-scale-factor=1.25 --num-raster-threads=2 --enable-main-frame-before-activation --renderer-client-id=5 --time-ticks-at-unix-epoch=-1716905072841611 --launch-time-ticks=235760065154 --mojo-platform-channel-handle=3008 --field-trial-handle=1772,i,6040642380323937610,4487286942128377462,131072 --disable-features=SpareRendererForSitePerProcess,WinRetrieveSuggestionsOnlyOnDemand /prefetch:1
 ******************************************************************************/
